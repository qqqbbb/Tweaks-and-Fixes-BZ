...
namespace Tweaks_Fixes
{
    public class OptionsMenu : ModOptions
    {
        public OptionsMenu() : base("Tweaks and Fixes")
        {
            ...
            ModSliderOption vehicleCrushDamageSlider = ConfigMenu.vehicleCrushDamageMult.ToModSliderOption(0f, 10f, .1f, "{0:0.##}");
        ...
        {
            //Main.logger.LogInfo("InvMultSliderUpdate  " + ConfigMenu.invMultLand.Value);
